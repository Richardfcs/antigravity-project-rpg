...
const LibraryManager = (function() {
    ...
    const initialData = [
        ...
        { id: 'lib_c28', nome: "Dano: Cálculo e Multiplicadores", cat: "Regra", sub: "Dano", fonte: "[Manual]", desc: "Tipo | Sigla | Mult. | Exemplo\nContusão | esm | x1 | Bastão, Soco\nCorte | cort | x1.5 | Katana, Naginata\nPerfuração | perf | x2 | Lança, Flecha\nPerf. Pequeno | pi- | x0.5 | Shuriken, Dardo\n\nSubtraia a RD da armadura do dano básico e multiplique o resto pelo fator acima.", tags: ["Combate", "Dano"] },
        { id: 'lib_c29', nome: "Dano: Localização de Acerto", cat: "Regra", sub: "Dano", fonte: "[Manual]", desc: "Local | Penal. | Efeito Especial\nTronco | 0 | Padrão.\nVitais | -3 | Dano x3 (Apenas Perfuração).\nRosto | -5 | Ignora armadura (exceto máscara).\nPescoço | -5 | Dano x2 (Corte ou Perfuração).\nCrânio | -7 | RD fixa 2. Dano x4. Nocaute.\nMembros | -2 | Inutiliza se dano > PV/2.\nMão/Pé | -4 | Inutiliza se dano > PV/3.\nOlhos | -9 | Cegueira. Dano direto ao cérebro (x4).", tags: ["Combate", "Dano"] },
        ...
        { id: 'lib_c34', nome: "Referência: Golpe Fulminante (Crítico)", cat: "Regra", sub: "Referência", fonte: "[MB B556]", desc: "3d6 | Efeito\n3-4 | DANO TRIPLO.\n5 | DANO DOBRADO.\n6 | Dano normal, sem defesa.\n7 | Ferimento Grave (teste HT).\n8 | Atinge Membro (inutiliza).\n12 | Derruba Arma.\n13-14 | IGNORA ARMADURA (RD 0).\n15+ | Dano Dobrado/Triplo.", tags: ["Combate", "Referência"] },
        { id: 'lib_c35', nome: "Referência: Falha Crítica (Desastre)", cat: "Regra", sub: "Referência", fonte: "[MB B556]", desc: "3d6 | O Desastre\n3-4 | QUEBRA A ARMA.\n5-6 | ATINGE A SI MESMO (braço ou perna).\n7-8 | PERDE O EQUILÍBRIO (sem defesa até prox. turno).\n9-12 | DERRUBA A ARMA (voa a 1 metro).\n13-14 | Perde equilíbrio/Atinge a si mesmo.\n15+ | Quebra a arma.", tags: ["Combate", "Referência"] },
