...
if (typeof window.RangedCalc === 'undefined') {
  window.RangedCalc = (function() {
    ...
    function update() {
      ...
      const bRange = document.getElementById('rc-breakdown-range');
      if (bRange) bRange.textContent = `Distância: ${rangeMod >= 0 ? '+' : ''}${rangeMod}`;
    }
